                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="rooms.php">Hotels</a></li>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <form class="reservation-vertical clearfix" role="form" method="post" action="">
                    ...
                    <div class="price">
                        ...
                        Tk. <?php echo $room_price; ?><span> a night</span>
                    </div>
            ...
            <div class="container">
                <div class="row">
                  ...
                  foreach ($res as $row) {
                    $i++;
                  ?>
                                    <td><i class="<?php echo $row['room_feature_icon']; ?>"></i>
                                        <?php echo $row['room_feature_name']; ?></td>
                                    <?php
                    if ($i % 3 == 0) {
                      echo '</tr><tr>';
                    }
...
<section class="rooms mt50">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="lined-heading"><span>Related Hotels</span></h2>
            </div>
