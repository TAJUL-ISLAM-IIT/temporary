...
<div class="container">
    <div class="row">
        ...
        ?>
                <li><a href="#"
                        data-filter=".ty<?php echo $row['room_type_id']; ?>"><?php echo $row['room_type_name']; ?></a>
                </li>
                <?php
        }
        ?>
                ...
                <div class="room-thumb">
                    ...
                    <div class="mask">
                        <div class="main">
                            ...
                            <div class="price"> <?php echo 'Tk.' . $row['room_price']; ?><span>a night</span></div>
                        </div>
                        <div class="content">
                            <p>
                  ...
                  ?>
                      ...
                      ?>
                            ...
                            <a href="room.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-block">View
                                Details</a>
                            <a href="room.php?id=<?php echo $row['room_id']; ?>" class="btn btn-primary btn-block">Book
                                Now</a>
